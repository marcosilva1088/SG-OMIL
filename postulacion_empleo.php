...
<div id="wrapper">
    ...
    <form method="POST" action="postulacion_empleo.php" class="formulario" id="formulario_postulacion_empleo">
        <div class="formulario__grupo">
            <label for="rut" class="formulario__label">RUT de Usuario Vecinal:</label>
            <div class="formulario__grupo-input">
                <select id="rut" name="rut" id="rut" class="formulario__input" required>
                    <?php
        ...
        <div class="formulario__grupo">
            <label for="verificar_datos" class="formulario__label">Verificar datos del usuario:</label>
            <div class="formulario__grupo-input">
                <input type="checkbox" name="verificar_datos" id="verificar_datos" class="formulario__input">
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="rango_etario" class="formulario__label">Verificar rango etario de la oferta:</label>
            <div class="formulario__grupo-input">
                <select name="rango_etario" id="rango_etario" class="formulario__input" required>
        ...
        <div class="formulario__grupo">
            <label for="oferta_empleo" class="formulario__label">Oferta de Empleo:</label>
            <div class="formulario__grupo-input">
                <select id="oferta_empleo" name="oferta_empleo" class="formulario__input" required>
                    <?php
