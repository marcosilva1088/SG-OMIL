...
$sql = "SELECT dc.*, r.nombre
FROM sg_omil_derivacion_capacitacion AS dc
LEFT JOIN sg_omil_regiones AS r ON dc.Region = r.id;";
...
<head>
    ...
    <title>Administración de Derivacion de Capacitacion</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Derivacion de Capacitacion</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Derivacion Capacitacion
                </div>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='edit-btn' href='editar_derivacion_capacitacion.php?id={$row['id']}'>Editar</a>";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_derivacion_capacitacion.php?id={$row['id']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
