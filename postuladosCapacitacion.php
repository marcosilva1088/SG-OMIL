...
$sql = "SELECT * FROM sg_omil_datos_postulacion_capacitacion;";
...
<head>
    ...
    <title>Administración de Postulados Capacitacion</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Postulaciones Capacitacion</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Postulaciones de Capacitacion a Usuairios Vecinales
                </div>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>{$row['ID']}</td>";
                                        echo "<td>{$row['Rut']}</td>";
                                        echo "<td>{$row['PorcentajeRSH']}</td>";
                                        echo "<td>{$row['NivelEstudios']}</td>";
                                        echo "<td>{$row['EsJefaHogar']}</td>";
                                        echo "<td>{$row['Discapacidad']}</td>";
                                        echo "<td>{$row['RangoEtario']}</td>";
                                        echo "<td>{$row['PuntajeEntrevista']}</td>";
                                        echo "<td>{$row['OfertaCapacitacionID']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_postulados_capacitacion.php?id={$row['ID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
