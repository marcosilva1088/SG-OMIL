...
$sql = "SELECT OcupacionID, RutUsuarioVecinal, AdjuntoDocumento, EstadoUsuario FROM sg_omil_ocupacion_usuario_vecinal";
$result = $conn->query($sql);
...
<head>
    ...
    <title>Ocupaciones Usuarios Vecinales</title>
...
<div id="wrapper">
    ...
    <h2>Tabla de Ocupaciones Usuarios Vecinales</h2>
    <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Ocupaciones Usuarios Vecinales
                        </div>
    ...
    <thead>
        ...
        <?php foreach ($registros as $registro): ?>
            <tr>
                <td><?php echo $registro["OcupacionID"]; ?></td>
                <td><?php echo $registro["RutUsuarioVecinal"]; ?></td>
                <td><?php echo $registro["AdjuntoDocumento"]; ?></td>
                <td><?php echo $registro["EstadoUsuario"]; ?></td>
                <td><a class="edit-btn" href="descargar_adjunto.php?filename=<?php echo isset($registro["AdjuntoDocumento"]) ? urlencode($registro["AdjuntoDocumento"]) : ''; ?>">Descargar</a></td>

                <?php if ($rol === "administrador"): ?>
                    <td>
                        <a class='delete-btn' href='eliminar_ocupacion.php?id=<?php echo $registro['OcupacionID']; ?>'>Eliminar</a>
                    </td>
                <?php endif; ?>
            </tr>
        <?php endforeach; ?>
