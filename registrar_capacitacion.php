...
<div id="wrapper">
    ...
    <form method="POST" action="registrar_capacitacion.php" class="formulario" id="formulario_registrar_capacitacion">
        <div class="formulario__grupo">
            <label for="rut_usuario" class="formulario__label">Rut de Usuario Vecinal Matriculado:</label>
            <div class="formulario__grupo-input">
                <select id="rut_usuario" name="rut_usuario" class="formulario__input" required>
                    <?php
        ...
        <div class="formulario__grupo">
            <label for="nombre_capacitacion" class="formulario__label">Nombre de la Capacitación:</label>
            <div class="formulario__grupo-input">
                <select name="nombre_capacitacion" id="nombre_capacitacion" class="formulario__input" required>
                    <?php
        ...
        <div class="formulario__grupo">
            <label for="curso_completado" class="formulario__label">Curso Completado:</label>
            <div class="formulario__grupo-input">
                <input type="checkbox" id="curso_completado" name="curso_completado" value="1" class="formulario__input">
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="motivo_no_completado" class="formulario__label">Motivo por el que no completó el curso:</label>
            <div class="formulario__grupo-input">
                <textarea name="motivo_no_completado" class="formulario__input" id="motivo_no_completado"></textarea>
            </div>
        </div>

        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <input type="submit" value="Registrar Capacitación" class="formulario__btn">
        </div>
    </form>
