...
<div id="wrapper">
    ...
    <br>
    <form method="POST" action="asociar_capacitacion.php" class="formulario" id="formulario_asociar_capacitacion">
        ...
        <div class="formulario__grupo">
            <label for="oferta_capacitacion_id" class="formulario__label">Oferta de Capacitación:</label>
            <div class="formulario__grupo-input">
                <select id="oferta_capacitacion_id" name="oferta_capacitacion_id" class="formulario__input" required>
                    <?php
                    // Genera las opciones del menú desplegable con los IDs de las ofertas de empleo
        ...
        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <input type="submit" value="Asociar Oferta de Capacitación" class="formulario__btn">
        </div>
    </form>
