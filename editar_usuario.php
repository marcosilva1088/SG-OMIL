...
// Corrige el nombre de la variable de contraseña
...
// Obtén los datos del usuario según el ID proporcionado
$id = $_GET['id'];
$sql = "SELECT * FROM sg_omil_usuarios WHERE id = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE sg_omil_usuarios SET username='$newUsername', email='$newEmail', password='$newPassword', rol='$newRol' WHERE id=$id";
...
<form method="POST" action="" class="formulario" id="formulario_registro_oferta">
    ...
    <div class="formulario__grupo">
        <label for="newUsername" class="formulario__label">Nuevo Nombre de Usuario:</label>
        <div class="formulario__grupo-input">
            <input class="formulario__input" type="text" id="newUsername" name="newUsername" value="<?php echo $row['username']; ?>" required>
        </div>
    </div>

    <div class="formulario__grupo">
        <label for="newEmail" class="formulario__label">Nuevo Correo Electrónico:</label>
        <div class="formulario__grupo-input">
            <input class="formulario__input" type="email" id="newEmail" name="newEmail" value="<?php echo $row['email']; ?>" required>
        </div>
    </div>

    <div class="formulario__grupo">
        <label for="newPassword" class="formulario__label">Nueva Contraseña:</label>
        <div class="formulario__grupo-input">
            <input class="formulario__input" type="password" id="newPassword" name="newPassword" placeholder="Deja en blanco para mantener la contraseña actual">
        </div>
    </div>

    <div class="formulario__grupo">
        <label for="newRol" class="formulario__label">Nuevo Rol:</label>
        <div class="formulario__grupo-input">
            <select class="formulario__input" id="newRol" name="newRol" required>
    ...
    <div class="formulario__grupo formulario__grupo-btn-enviar">
        <input class="formulario__btn" type="submit" value="Guardar cambios">
    </div>
</form>
