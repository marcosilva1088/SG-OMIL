...
$sql = "SELECT RutEmpresa, CONCAT(' Rut de Empresa: ', RutEmpresa, ' | ',' Nombre de Empresa: ', NombreEmpresa, ' | ', ' Sector: ', Sector) AS DatosEmpresa FROM sg_omil_ofertasempleo";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO sg_omil_visitas_empresas (RutEmpresa, FechaVisita, HoraInicio, Proposito, DuracionEstimada) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $RutEmpresa, $fecha_visita, $hora_inicio, $proposito, $duracion_estimada);
    ...
    if ($stmt->execute()) {
        ...
        if ($result->num_rows == 1) {
            ...
            $message = "Hemos programado una visita a su empresa para el $fecha_visita a la hora estimada de $hora_inicio. El propósito de la visita es: $proposito. La duración estimada es de $duracion_estimada horas.";
            $headers = 'From: sg.omil.melipilla@gmail.com';
...
<head>
    ...
    <title>Registrar Visita a Empresa</title>
...
<div id="wrapper">
    ...
    <h2>Registrar Visita a Empresa</h2>
    <form method="POST" action="visita_empresa.php" class="formulario" id="formulario_visita_empresa">
        <div class="formulario__grupo">
            <label for="RutEmpresa" class="formulario__label">Rut de Empresa:</label>
            <div class="formulario__grupo-input">
                <select id="RutEmpresa" name="RutEmpresa" class="formulario__input" required>
                    <?php
        ...
        <div class="formulario__grupo">
            <label for="fecha_visita" class="formulario__label">Fecha de Visita:</label>
            <div class="formulario__grupo-input">
                <input type="date" name="fecha_visita" id="fecha_visita" class="formulario__input" required>
            </div>
        </div>
        ...
        <div class="formulario__grupo">
            ...
            <div class="formulario__grupo-input">
                <input type="time" name="hora_inicio" id="hora_inicio" class="formulario__input" required>
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="proposito" class="formulario__label">Propósito de la Visita:</label>
            <div class="formulario__grupo-input">
                <input type="text" name="proposito" id="proposito" class="formulario__input" required>
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="duracion_estimada" class="formulario__label">Duración Estimada (horas):</label>
            <div class="formulario__grupo-input">
                <input type="number" name="duracion_estimada" id="duracion_estimada" class="formulario__input" required>
            </div>
        </div>

        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <input type="submit" value="Registrar Visita" class="formulario__btn">
        </div>
    </form>
