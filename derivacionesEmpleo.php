...
$sql = "SELECT dol.*, r.nombre
FROM sg_omil_derivacion_oportunidad_laboral AS dol
LEFT JOIN sg_omil_regiones AS r ON dol.Region = r.id;
";
...
<head>
    ...
    <title>Administración de Derivacion de Oportunidad Laboral</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Derivacion de Oportunidad Laboral</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Derivacion Empleo
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>ID de Derivacion</th>
                                    <th>Fecha de Derivacion</th>
                                    <th>Rut de Usuario Vecinal</th>
                                    <th>Nombres</th>
                                    <th>Apellidos</th>
                                    <th>Genero</th>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>{$row['celular_alternativo']}</td>";
                                        echo "<td>{$row['correo_electronico']}</td>";
                                        echo "<td>{$row['nombre']}</td>";
                                        echo "<td>{$row['comuna']}</td>";
                                        echo "<td>{$row['sector']}</td>";
                                        echo "<td>{$row['direccion']}</td>";
                                        echo "<td>{$row['nivel_educacional']}</td>";
                                        echo "<td>{$row['area']}</td>";
                                        echo "<td>{$row['titulo']}</td>";
                                        echo "<td>{$row['interes_empleo']}</td>";
                                        echo "<td>{$row['institucion']}</td>";
                                        echo "<td>{$row['fecha']}</td>";
                                        echo "<td>{$row['motivo_derivacion']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='edit-btn' href='editar_derivacion_empleo.php?id={$row['id']}'>Editar</a>";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_derivacion_empleo.php?id={$row['id']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
