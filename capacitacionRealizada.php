...
$sql = "SELECT * FROM sg_omil_registrar_capacitacion;";
...
<head>
    ...
    <title>Administración de Capacitacion Realizada</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Capacitacion Realizada</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Capacitacion Realizada
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th>¿Curso Completado?</th>
                                    <th>Motivo de No Completado</th>
                                    <?php if ($rol === "administrador"): ?>
                                    <th>Acciones</th>
                                    <?php endif; ?>
                                </tr>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>{$row['ID']}</td>";
                                        echo "<td>{$row['Rut']}</td>";
                                        echo "<td>{$row['NombreCapacitacion']}</td>";
                                        echo "<td>{$row['CursoCompletado']}</td>";
                                        echo "<td>{$row['MotivoNoCompletado']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_realizada_capacitacion.php?id={$row['ID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
