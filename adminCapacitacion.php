...
<head>
    ...
    <title>Tabla Ofertas de Capacitacion</title>
    ...
    <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <h2>Administracion de Ofertas de Capacitacion</h2>
<div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Ofertas de Capacitación
                </div>
                <div class="panel-body">
                    <!-- Agregar la clase table-responsive al contenedor de la tabla -->
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>OfertaCapacitacionID</th>
                                    <th>FechaCreacion</th>
                                    <th>RutEmpresaOTEC</th>
                                    <th>NombreOTEC</th>
                                    <th>Sector</th>
                                    ...
                                    <th>Lugar</th>
                                    <th>Costo</th>
                                    <th>EstudiosRequeridos</th>
                                    <th>DocumentacionRequerida</th>
                                    <th>GruposObjetivos</th>
                                    <?php if ($rol === "administrador"): ?>
                                    <th>Acciones</th>
                                    <?php endif; ?>
                                </tr>
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM sg_omil_ofertascapacitacion";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>";
                                        echo "<a class='edit-btn' href='editar_capacitacion.php?id={$row['OfertaCapacitacionID']}'>Editar</a>";
                                        echo "<br>";
                                        echo "<br>";
                                        echo "<a class='delete-btn' href='eliminar_capacitacion.php?id={$row['OfertaCapacitacionID']}'>Eliminar</a>";
                                        echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
