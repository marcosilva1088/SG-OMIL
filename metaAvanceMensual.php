...
$sql = "SELECT * FROM sg_omil_metas_anuales";
$result = $conn->query($sql);

// Consulta SQL para obtener todos los registros de la tabla
$sql = "SELECT * FROM sg_omil_avance_mensual";
...
<head>
    ...
    <title>Administración de Metas Anuales y Avances Mensuales</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Metas Anuales</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>{$row['MetaID']}</td>";
                                        echo "<td>{$row['NombreMeta']}</td>";
                                        echo "<td>{$row['Anio']}</td>";
                                        echo "<td>{$row['Meta']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='delete-btn' href='eliminar_meta_anual.php?id={$row['MetaID']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
    ...
    <h2>Administración de Avance Mensual</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Avance Mensual
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                if ($result2->num_rows > 0) {
                                    while ($row = $result2->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>{$row['AvanceID']}</td>";
                                        echo "<td>{$row['MetaID']}</td>";
                                        echo "<td>{$row['Mes']}</td>";
                                        echo "<td>{$row['Cumplimiento']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='delete-btn' href='eliminar_avance_mensual.php?id={$row['AvanceID']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
