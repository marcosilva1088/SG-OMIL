...
$sql = "SELECT uv.*, r.nombre
FROM sg_omil_usuariosvecinales AS uv
LEFT JOIN sg_omil_regiones AS r ON uv.Region = r.id;
...
<div id="wrapper">
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>";
                                        echo "<a class='edit-btn' href='editar_usuario_vecinal.php?id={$row['UsuarioID']}'>Editar</a>   ";
                                        echo "<br>";
                                        echo "<br>";
                                        echo "<a class='delete-btn' href='eliminar_usuario_vecinal.php?id={$row['UsuarioID']}'>Eliminar</a>";
                                        echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
    ...
    <form action="generate_pdf.php" method="post">
        <input class="edit-btn" type="submit" name="generate_report_pdf" value="Generar Informe en PDF">
    </form>
