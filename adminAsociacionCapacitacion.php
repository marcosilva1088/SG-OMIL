...
FROM  sg_omil_asociacionusuarioscapacitacion AS ac
LEFT JOIN sg_omil_usuariosvecinales AS uv ON uv.UsuarioID = ac.UsuarioID LEFT JOIN sg_omil_ofertascapacitacion AS oc ON ac.OfertaCapacitacionID = oc.OfertaCapacitacionID;
...
<head>
    ...
    <title>Administración de Asociaciones Capacitacion</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Asociaciones Capacitacion</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Asociaciones de Capacitacion a Usuairios Vecinales
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th>RUT</th>
                                    <th>Género</th>
                                    <th>ID Oferta Capacitacion</th>
                                    <th>Rut Empresa OTEC</th>
                                    <th>Nombre Empresa OTEC</th>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_asociacion_capacitacion.php?id={$row['AsociacionID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
