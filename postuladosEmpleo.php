...
$sql = "SELECT * FROM sg_omil_datos_postulacion_empleo;";
...
<head>
    ...
    <title>Administración de Postulados Empleo</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Postulaciones Empleo</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Postulaciones de Empleo a Usuairios Vecinales
                </div>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>{$row['ID']}</td>";
                                        echo "<td>{$row['Rut']}</td>";
                                        echo "<td>{$row['VerificarDatosUsuario']}</td>";
                                        echo "<td>{$row['RangoEtario']}</td>";
                                        echo "<td>{$row['OfertaEmpleoID']}</td>";
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_postulado_empleo.php?id={$row['ID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
