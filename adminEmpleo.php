...
<head>
    ...
    <title>Tabla Ofertas de Empleo</title>
    ...
    <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <h2>Administracion Ofertas de Empleo</h2>
<div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM sg_omil_ofertasempleo";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='edit-btn' href='editar_empleo.php?id={$row['OfertaEmpleoID']}'>Editar</a>";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_empleo.php?id={$row['OfertaEmpleoID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
