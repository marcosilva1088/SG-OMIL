...
$sql = "SELECT * FROM sg_omil_seguimiento_laboral";
...
<head>
    ...
    <title>Administración de Seguimiento Laboral</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Seguimiento Laboral</h2>
        <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Seguimiento Laboral a Usuarios Vecinales
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th>Empleo Postulado</th>
                                    <th>Seguimiento de la Postulacion</th>
                                    <?php if ($rol === "administrador"): ?>
                                        <th>Acciones</th>
                                    <?php endif; ?>
                                </tr>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ?>
                                    <tr>
                                        <td><?php echo $row['SeguimientoID']; ?></td>
                                        <td><?php echo $row['Rut']; ?></td>
                                        <td><?php echo $row['PostulacionEmpleo']; ?></td>
                                        <td><?php echo $row['SeguimientoEmpleo']; ?></td>
                                        <?php if ($rol === "administrador"): ?>
                                            <td>
                                                <a class='delete-btn' href='eliminar_seguimiento.php?id=<?php echo $row['SeguimientoID']; ?>'>Eliminar</a>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                    <?php
