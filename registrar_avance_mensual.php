...
<div id="wrapper">
    ...
    <form method="POST" action="registrar_avance_mensual.php" class="formulario" id="formulario_registro_avance_mensual">
        <div class="formulario__grupo">
            <label for="meta_id" class="formulario__label">Meta Anual:</label>
            <div class="formulario__grupo-input">
                <select id="meta_id" name="meta_id" class="formulario__input" required>
                    <?php
        ...
        <div class="formulario__grupo">
            ...
            <div class="formulario__grupo-input">
                <input type="number" name="mes" id="mes" class="formulario__input" required>
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="cumplimiento" class="formulario__label">Cumplimiento:</label>
            <div class="formulario__grupo-input">
                <input type="text" name="cumplimiento" id="cumplimiento" class="formulario__input" required>
            </div>
        </div>

        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <input type="submit" value="Registrar Avance Mensual" class="formulario__btn">
        </div>
    </form>
