...
$sql = "SELECT uv.*, oc.*, ac.AsociacionID
FROM  sg_omil_asociacionusuariosempleo AS ac
LEFT JOIN sg_omil_usuariosvecinales AS uv ON uv.UsuarioID = ac.UsuarioID LEFT JOIN sg_omil_ofertasempleo AS oc ON ac.OfertaEmpleoID = oc.OfertaEmpleoID;
...
<head>
    ...
    <title>Administración de Asociaciones Empleo</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Asociaciones Empleo</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Asociaciones de Empleo a Usuairios Vecinales
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th>ID de Asociacion</th>
                                    <th>ID Usuario</th>
                                    <th>Nombres</th>
                                    <th>Apellidos</th>
                                    <th>RUT</th>
                                    <th>Género</th>
                                    <th>ID Oferta Empleo</th>
                                    <th>Rut Empresa</th>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<br>";
                                            echo "<a class='delete-btn' href='eliminar_asociacion_empleo.php?id={$row['AsociacionID']}'>Eliminar</a>";
                                            echo "</td>";
                                            endif;
                                        echo "</tr>";
                                    }
