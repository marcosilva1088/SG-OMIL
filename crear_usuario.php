...
<div id="wrapper">
    ...
    <br>
    <form method="POST" action="crear_usuario.php" class="formulario" id="formulario">
        <div class="formulario__grupo" id="grupo__usuario">
            <label for="username" class="formulario__label">Nombre de usuario:</label>
            <div class="formulario__grupo-input">
                <input class="formulario__input" type="text" id="username" name="username" required><br><br>
            </div>
        </div>
        <div class="formulario__grupo" id="grupo__usuario">
            <label for="email" class="formulario__label">Correo Electrónico:</label>
            <div class="formulario__grupo-input">
                <input class="formulario__input" type="text" id="email" name="email" required><br><br>
            </div>
        </div>
        <div class="formulario__grupo" id="grupo__usuario">
            <label for="password" class="formulario__label">Contraseña:</label>
            <div class="formulario__grupo-input">
                <input class="formulario__input" type="password" id="password" name="password" required><br><br>
            </div>
        </div>
        <div class="formulario__grupo" id="grupo__usuario">
        <label for="rol" class="formulario__label">Rol:</label>
        <div class="formulario__grupo-input">
            <select class="formulario__input" id="rol" name="rol" required>
        ...
        <div class="formulario__grupo formulario__grupo-btn-enviar">
            <input class="formulario__btn" type="submit" value="Crear Usuario">
        </div>
    </form>
