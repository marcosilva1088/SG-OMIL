...
<div id="wrapper">
    ...
    <?php endif; ?>
    <form action="registrar_ocupacion.php" method="post" enctype="multipart/form-data" class="formulario" id="formulario_registrar_ocupacion">
        <div class="formulario__grupo">
            <label for="rut" class="formulario__label">Rut:</label>
            <div class="formulario__grupo-input">
                <!-- Utiliza un elemento select para mostrar los RUTs -->
                <select name="rut" id="rut" class="formulario__input" required>
        ...
        <div class="formulario__grupo">
            <label for="adjunto" class="formulario__label">Adjuntar Documento de Respaldo:</label>
            <div class="formulario__grupo-input">
                <input type="file" id="adjunto" name="adjunto" accept=".pdf, .doc, .docx" class="formulario__input"><br>
            </div>
        </div>

        <div class="formulario__grupo">
            <label for="estado" class="formulario__label">Estado del Usuario:</label>
            <div class="formulario__grupo-input">
