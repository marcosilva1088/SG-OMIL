...
$sql = "SELECT * FROM sg_omil_visitas_otecs";
$result = $conn->query($sql);

// Consulta SQL para obtener todos los registros de la tabla
$sql = "SELECT * FROM sg_omil_reportes_visita_otecs";
...
<head>
    ...
    <title>Administración de Visita y Reporte OTEC</title>
...
<div id="wrapper">
    ...
    <h2>Administración de Visita OTEC</h2>
    <div class="row">
        <div class="col-md-12">
            <!-- Advanced Tables -->
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Visita a OTEC
                </div>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='delete-btn' href='eliminar_visita_otec.php?id={$row['VisitaID']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
                            ...
                            <tbody>
                                ...
                                if ($result2->num_rows > 0) {
                                    while ($row = $result2->fetch_assoc()) {
                                        ...
                                        if ($rol === "administrador"):
                                            echo "<td>";
                                            echo "<a class='delete-btn' href='eliminar_reporte_visita_otec.php?id={$row['ReporteID']}'>Eliminar</a>";
                                            echo "</td>";
                                        endif;
                                        echo "</tr>";
                                    }
