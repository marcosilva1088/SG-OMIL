...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"])) {
    ...
    $updateQuery = "UPDATE sg_omil_derivacion_capacitacion SET ";
    ...
    if ($conn->query($updateQuery) === TRUE) {
        ...
        header("location: derivacionesCapacitacion.php");
        exit;
    } else {
...
if (isset($_GET["id"])) {
    ...
    $consulta = "SELECT * FROM sg_omil_derivacion_capacitacion WHERE id = $id";
...
<meta charset="UTF-8">
    ...
    <title>Editar Derivación para Capacitacion</title>
...
<div id="wrapper">
    ...
    <form method="post" action="" class="formulario">
        ...
        <div class="formulario__grupo">
            ...
            <div class="formulario__grupo-input">
                <input type="text" id="nombre_curso" name="nombre_curso" class="formulario__input" required value="<?php echo $row['nombre_curso']; ?>">
            </div>
        </div>
